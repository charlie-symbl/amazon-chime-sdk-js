const {ClickContentShareVideoTestButton} = require('./steps');
...
class ContentShareVideoTest extends SdkBaseTest {
  ...
  async runIntegrationTest() {
    ...
    await test_window_2.runCommands(async () => await ClickContentShareVideoTestButton.executeStep(this, session, "ON"));
    await TestUtils.waitAround(5000);
    ...
    await test_window_2.runCommands(async () => await ClickContentShareVideoTestButton.executeStep(this, session, "OFF"));
    await TestUtils.waitAround(5000);
    await test_window_2.runCommands(async () => await RosterCheck.executeStep(this, session, 2));
